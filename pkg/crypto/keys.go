...
// GenerateKeyPair generates a new secp256k1 key pair for Bitcoin/FIX compatibility
...
// Alias for CompressedBytes() for Bitcoin/PIVX/FIX compatibility
...
// For FIX: mainnet prefix is 66 (0x42), testnet prefix is 237 (0xED)
...
// version: network version byte (66/0x42 for FIX mainnet, 237/0xED for testnet)
...
func ParseSignatureFromBytes(data []byte) (*Signature, error) {
	// Try DER format first (legacy FIX format)
