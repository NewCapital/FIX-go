...
// Bitcoin message magic used in legacy FIX (inherited from DASH/PIVX)
const MessageMagic = "DarkNet Signed Message:\n"

// SignCompact creates a compact signature (65 bytes) compatible with Bitcoin/legacy FIX
...
// This matches the legacy FIX signing format (Bitcoin/DASH/PIVX compatible):
//
