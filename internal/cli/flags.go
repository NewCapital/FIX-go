...
func CommonWalletFlags() []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{
			...
			EnvVars: []string{"FIX_WALLET_NAME"},
		},
		&cli.BoolFlag{
			Name:    "wallet-create",
			Usage:   "Create wallet if it doesn't exist",
			EnvVars: []string{"FIX_WALLET_CREATE"},
		},
		&cli.StringFlag{
			Name:    "wallet-passphrase",
			Usage:   "Wallet encryption passphrase",
			EnvVars: []string{"FIX_WALLET_PASSPHRASE"},
		},
		&cli.BoolFlag{
			Name:    "wallet-testnet",
			Value:   false,
			Usage:   "Use testnet address format",
			EnvVars: []string{"FIX_WALLET_TESTNET"},
		},
		...
		&cli.Int64Flag{
			...
			EnvVars: []string{"FIX_PAYTXFEE"},
		},
		&cli.Int64Flag{
			Name:    "mintxfee",
			Value:   10000,
			Usage:   "Minimum transaction fee threshold (in satoshis)",
			EnvVars: []string{"FIX_MINTXFEE"},
		},
		&cli.Int64Flag{
			Name:    "maxtxfee",
			Value:   100000000,
		...
		&cli.IntFlag{
			...
			EnvVars: []string{"FIX_TXCONFIRMTARGET"},
		},
