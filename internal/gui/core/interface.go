...
// CoreClient is the main interface to the FIX blockchain core.
...
type CoreClient interface {
	...
	// Returns the fee rate in FIX per KB.
	...
	// - Returns the fee in FIX along with input count and tx size for UI display
	...
	// address: the FIX address to look up
