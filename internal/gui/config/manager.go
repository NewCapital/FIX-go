...
type CombinedConfig struct {
	FIX         *initialization.FIXConfig        `json:"fix"`
...
// Manager handles masternode.conf management for the FIX wallet.
// FIX daemon config (fixd.yml / fix.conf) is owned by ConfigManager;
...
func (m *Manager) saveMasternodeConfig() error {
	...
	lines = append(lines, "# Example: mn1 127.0.0.1:17464 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87333b3e5c2d3e3e3e3e3e3e3e3e3e3e3e3e3e3e3e3e3e3e3e3e 0")
	lines = append(lines, "")
