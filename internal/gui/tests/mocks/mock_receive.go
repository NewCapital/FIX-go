...
// GenerateFIXURI generates a fix: URI for payment requests
// Format: fix:ADDRESS?amount=VALUE&label=LABEL&message=MESSAGE
func GenerateFIXURI(address string, amount float64, label, message string) string {
	// Start with base URI
	uri := "fix:" + address
