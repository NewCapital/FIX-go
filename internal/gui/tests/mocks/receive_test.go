...
func TestGenerateFIXURI(t *testing.T) {
	tests := []struct {
		name     string
		address  string
		amount   float64
	...
	}{
		{
			...
			label:    "",
			message:  "",
			expected: "fix:D1234567890123456789012345678901234",
		},
		{
			name:     "with amount",
			address:  "D1234567890123456789012345678901234",
			...
			label:    "",
			message:  "",
			expected: "fix:D1234567890123456789012345678901234?amount=100.50000000",
		},
		{
			name:     "with label",
			address:  "D1234567890123456789012345678901234",
			...
			label:    "Test Label",
			message:  "",
			expected: "fix:D1234567890123456789012345678901234?label=Test+Label",
		},
		{
			...
			label:    "Payment",
			message:  "Thank you",
			expected: "fix:D1234567890123456789012345678901234?amount=50.00000000&label=Payment&message=Thank+you",
		},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			uri := GenerateFIXURI(tt.address, tt.amount, tt.label, tt.message)
			if uri != tt.expected {
