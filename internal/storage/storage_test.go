...
import (
	...
	stpkg "github.com/NewCapital/FIX-go/internal/storage"
...
func testChainStateOperations(t *testing.T, storage *binarystorage.BinaryStorage) {
	...
	t.Run("MoneySupply", func(t *testing.T) {
		...
		testSupply := int64(1084183789900000000) // ~10.8B FIX in satoshis
		...
		testSupply2 := int64(1084183789900000000 + 5000000000) // +50 FIX
