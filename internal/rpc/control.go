...
var commandHelpTexts = map[string]string{
	...
	"getrawmempool": "getrawmempool ( verbose )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli getrawmempool\n" +
		"> fix-cli getrawmempool true",
	...
	"getmempoolentry": "getmempoolentry \"txid\"\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli getmempoolentry \"mytxid\"",
	...
	"getmempoolancestors": "getmempoolancestors \"txid\" ( verbose )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli getmempoolancestors \"mytxid\"",
	...
	"getmempooldescendants": "getmempooldescendants \"txid\" ( verbose )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli getmempooldescendants \"mytxid\"",
	...
	"masternode": "masternode \"command\"...\n\n" +
		...
		"Examples:\n" +
		"> fix-cli masternode count\n" +
		"> fix-cli masternode list",
	...
	"startmasternode": "startmasternode \"set\" \"lockwallet\" ( \"alias\" )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli startmasternode \"alias\" \"false\" \"my_mn\"\n" +
		"> fix-cli startmasternode \"all\" \"true\"",
	...
	"createmasternodebroadcast": "createmasternodebroadcast \"command\" ( \"alias\" )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli createmasternodebroadcast \"alias\" \"my_mn\"\n" +
		"> fix-cli createmasternodebroadcast \"all\"",
	...
	"decodemasternodebroadcast": "decodemasternodebroadcast \"hexstring\"\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli decodemasternodebroadcast \"hexstring\"",
	...
	"relaymasternodebroadcast": "relaymasternodebroadcast \"hexstring\"\n\n" +
		...
		"Examples:\n" +
		"> fix-cli relaymasternodebroadcast \"hexstring\"",
	...
	"stopmasternode": "stopmasternode \"set\" ( \"alias\" )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli stopmasternode \"alias\" \"my_mn\"\n" +
		"> fix-cli stopmasternode \"all\"",
	...
	"setmocktime": "setmocktime timestamp\n\n" +
		...
		"Examples:\n" +
		"> fix-cli setmocktime 1503840000",
	...
	"mnsync": "mnsync \"command\"\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli mnsync status\n" +
		"> fix-cli mnsync reset",
	...
	"sendfrom": "sendfrom \"fromaccount\" \"tofixaddress\" amount ( minconf \"comment\" \"comment-to\" )\n\n" +
		...
		"\"transactionid\"        (string) The transaction id.\n\n" +
		"Examples:\n" +
		"> fix-cli sendfrom \"\" \"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\" 0.01\n" +
		"> fix-cli sendfrom \"tabby\" \"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\" 0.01 6 \"donation\" \"seans outpost\"",
	...
	"getaccount": "getaccount \"fixaddress\"\n\n" +
		...
		"Examples:\n" +
		"> fix-cli getaccount \"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\"",
	...
	"listreceivedbyaddress": "listreceivedbyaddress ( minconf includeempty includeWatchonly )\n\n" +
		...
		"]\n\n" +
		"Examples:\n" +
		"> fix-cli listreceivedbyaddress\n" +
		"> fix-cli listreceivedbyaddress 6 true",
	...
	"listreceivedbyaccount": "listreceivedbyaccount ( minconf includeempty includeWatchonly )\n\n" +
		...
		"]\n\n" +
		"Examples:\n" +
		"> fix-cli listreceivedbyaccount\n" +
		"> fix-cli listreceivedbyaccount 6 true",
	...
	"listtransactions": "listtransactions ( \"account\" count from includeWatchonly )\n\n" +
		...
		"]\n\n" +
		"Examples:\n" +
		"> fix-cli listtransactions\n" +
		"> fix-cli listtransactions \"*\" 20 100",
	...
	"gettransaction": "gettransaction \"txid\" ( includeWatchonly )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli gettransaction \"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"",
	...
	"listsinceblock": "listsinceblock ( \"blockhash\" target-confirmations includeWatchonly )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli listsinceblock\n" +
		"> fix-cli listsinceblock \"000000000000000bacf66f7497b7dc45ef753ee9a7d38571037cdb1a57f663ad\" 6",
	...
	"listaccounts": "listaccounts ( minconf includeWatchonly )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli listaccounts\n" +
		"> fix-cli listaccounts 6",
	...
	"getaddressinfo": "getaddressinfo \"address\"\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli getaddressinfo \"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\"",
	...
	"importaddress": "importaddress \"address\" ( \"label\" rescan )\n\n" +
		...
		"Examples:\n" +
		"> fix-cli importaddress \"myaddress\"\n" +
		"> fix-cli importaddress \"myaddress\" \"testing\" false",
	...
	"walletpassphrasechange": "walletpassphrasechange \"oldpassphrase\" \"newpassphrase\"\n\n" +
		...
		"Examples:\n" +
		"> fix-cli walletpassphrasechange \"old one\" \"new one\"",
	...
	"verifymessage": "verifymessage \"fixaddress\" \"signature\" \"message\"\n\n" +
		...
		"Examples:\n" +
		"> fix-cli verifymessage \"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\" \"signature\" \"my message\"",
	...
	"backupwallet": "backupwallet \"destination\"\n\n" +
		...
		"Examples:\n" +
		"> fix-cli backupwallet \"backup.dat\"",
	...
	"keypoolrefill": "keypoolrefill ( newsize )\n\n" +
		...
		"Examples:\n" +
		"> fix-cli keypoolrefill\n" +
		"> fix-cli keypoolrefill 100",
	...
	"reservebalance": "reservebalance ( reserve amount )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli reservebalance true 25",
	...
	"setstakesplitthreshold": "setstakesplitthreshold value\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli setstakesplitthreshold 5000",
	...
	"getstakesplitthreshold": "getstakesplitthreshold\n\n" +
		...
		"Examples:\n" +
		"> fix-cli getstakesplitthreshold",
	...
	"setautocombine": "setautocombine true|false ( target_amount )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli setautocombine true 200000\n" +
		"> fix-cli setautocombine false",
	...
	"multisend": "multisend \"command\" ( \"parameter\" )\n\n" +
		...
		"Examples:\n" +
		"> fix-cli multisend print\n" +
		"> fix-cli multisend \"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\" 50",
	...
	"createmultisig": "createmultisig nrequired [\"key\",...]\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli createmultisig 2 \"[\\\"DMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\"",
	...
	"getaddednodeinfo": "getaddednodeinfo dns ( \"node\" )\n\n" +
		...
		"]\n\n" +
		"Examples:\n" +
		"> fix-cli getaddednodeinfo true\n" +
		"> fix-cli getaddednodeinfo true \"192.168.0.201\"",
	...
	"setban": "setban \"ip(/netmask)\" \"add|remove\" (bantime) (absolute)\n\n" +
		...
		"Examples:\n" +
		"> fix-cli setban \"192.168.0.6\" \"add\" 86400\n" +
		"> fix-cli setban \"192.168.0.0/24\" \"add\"",
	...
	"setnetworkactive": "setnetworkactive true|false\n\n" +
		...
		"Examples:\n" +
		"> fix-cli setnetworkactive true\n" +
		"> fix-cli setnetworkactive false",
	...
	"invalidateblock": "invalidateblock \"hash\"\n\n" +
		...
		"None\n\n" +
		"Examples:\n" +
		"> fix-cli invalidateblock \"blockhash\"",
	...
	"reconsiderblock": "reconsiderblock \"hash\"\n\n" +
		...
		"None\n\n" +
		"Examples:\n" +
		"> fix-cli reconsiderblock \"blockhash\"",
	...
	"addcheckpoint": "addcheckpoint height hash\n\n" +
		...
		"Examples:\n" +
		"> fix-cli addcheckpoint 100000 \"0000000000000a1b2c3d4e5f...\"",
	...
	"getrewardrates": "getrewardrates ( height )\n\n" +
		...
		"}\n\n" +
		"Examples:\n" +
		"> fix-cli getrewardrates\n" +
		"> fix-cli getrewardrates 1000000",
	...
	"prioritisetransaction": "prioritisetransaction \"txid\" priority_delta fee_delta\n\n" +
		...
		"Examples:\n" +
		"> fix-cli prioritisetransaction \"txid\" 0.0 10000",
