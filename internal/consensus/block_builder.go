...
// GetBlockReward returns the block reward for the given height,
// using the bootstrap-phase boundary appropriate for this builder's network.
func (bb *BlockBuilder) GetBlockReward(height uint32) int64 {
	return blockreward.ForParams(height, bb.params)
}
