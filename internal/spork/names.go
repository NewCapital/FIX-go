...
func GetSporkName(id int32) string {
	...
	case SporkFIXEnableMasternodeTiers:
		return "SPORK_FIX_01_ENABLE_MASTERNODE_TIERS"
	case SporkFIXMinStakeAmount:
		return "SPORK_FIX_02_MIN_STAKE_AMOUNT"
	default:
		return "Unknown"
	}
}
...
func GetSporkID(name string) int32 {
	...
	case "SPORK_FIX_01_ENABLE_MASTERNODE_TIERS":
		return SporkFIXEnableMasternodeTiers
	case "SPORK_FIX_02_MIN_STAKE_AMOUNT":
		return SporkFIXMinStakeAmount
	default:
		return -1
	}
}
