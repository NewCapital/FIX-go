...
const (
	...
	// FIX-specific sporks (20190001+)
	SporkFIXEnableMasternodeTiers = 20190001
	SporkFIXMinStakeAmount        = 20190002
)
...
func (m *Message) Hash() [32]byte {
	...
	// Note: Legacy FIX used HashQuark (Quark hash algorithm) for spork hashing
