...
const (
	...
	TierBronze   MasternodeTier = 1 // 1M FIX
	TierSilver   MasternodeTier = 2 // 5M FIX
	TierGold     MasternodeTier = 3 // 20M FIX
	TierPlatinum MasternodeTier = 4 // 100M FIX
)
...
func GetMasternodeDNSSeeds(network string) []string {
	...
	case "mainnet":
		return []string{
			...
			"masternode2.fix.dev",
			"masternode3.fix.dev",
			"mn-seed1.fix.network",
			"mn-seed2.fix.network",
		}
	case "testnet":
		return []string{
			"testnet-mn1.fix.dev",
...
func GetMasternodeBootstrapAddresses(network string) []string {
	...
	case "mainnet":
		return []string{
			"45.32.220.182:17464",  // Known Platinum masternode
			"144.202.86.130:17464", // Known Gold masternode
			"45.77.227.147:17464",  // Known Gold masternode
			"207.148.18.151:17464", // Known Silver masternode
			"95.179.236.171:17464", // Known Silver masternode
		}
	case "testnet":
		return []string{
			"testnet1.fix.dev:37819",
			"testnet2.fix.dev:37819",
		}
	default:
		return []string{}
	}
