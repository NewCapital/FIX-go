...
func (s *Server) handleVersionMessage(peer *Peer, msg *Message) {
	...
	// Accept peers >= MinPeerProtocol (70926) for backward compatibility with legacy FIX mainnet.
...
// readCompactSize reads a Bitcoin/FIX varint (compactSize) from a reader
...
// writeCompactSize writes a Bitcoin/FIX varint (compactSize) to a writer
