...
// This replaces:
//   - cmd/fixd/startup_improved.go:startMasternodeManager() (cache loading part)
//   - cmd/fix-gui/app.go masternode cache loading
...
// This replaces:
//   - cmd/fixd/startup_improved.go:initializeMasternodeConf()
