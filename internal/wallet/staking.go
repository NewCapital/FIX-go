...
// Set to 100000 FIX so each half is at least 50000 FIX, safely above the
// legacy StakingMinInput of 12000 FIX (chainparams.cpp:243, main.cpp:3978).
...
func (w *Wallet) CreateCoinstakeTx(
	...
	// StakingMinInput (12000 FIX) so blocks are accepted by legacy C++ nodes.
	...
	if shouldSplit {
		...
		const CENT int64 = 1000000 // 0.01 FIX in satoshis
