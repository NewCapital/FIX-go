...
//
// All cases use the FIX mainnet canonical coinstake layout:
//
...
func TestCategorizeCoinstake(t *testing.T) {
	...
	const (
		stakeInputValue int64 = 10_000_000_000 // 100 FIX
		stakerReward    int64 = 100_000_000    // 1 FIX (staker portion)
		mnReward        int64 = 400_000_000    // 4 FIX (masternode portion)
		devReward       int64 = 50_000_000     // 0.5 FIX (dev fund)
	)
