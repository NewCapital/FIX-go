...
func TestProcessSyncStatusCount_UpdatesLastMasternodeList(t *testing.T) {
	...
	sm.ProcessSyncStatusCount("10.0.0.1:17464", int(SyncList), 5) // count > 0 so no fast-path
	after := time.Now().Unix()
...
func TestProcessSyncStatusCount_NoUpdateBelowThreshold(t *testing.T) {
	...
	sm.ProcessSyncStatusCount("10.0.0.1:17464", int(SyncList), 5)
...
func TestProcessSyncStatusCount_AdvancesWhenAllPeersReturnZero(t *testing.T) {
	...
	sm.ProcessSyncStatusCount("10.0.0.1:17464", int(SyncList), 0)
	sm.ProcessSyncStatusCount("10.0.0.2:17464", int(SyncList), 0)
...
func TestProcessSyncStatusCount_StaysInListWhenSomePeersReturnNonZero(t *testing.T) {
	...
	sm.ProcessSyncStatusCount("10.0.0.1:17464", int(SyncList), 0)
	sm.ProcessSyncStatusCount("10.0.0.2:17464", int(SyncList), 2)
