...
func registerAllSettings(cm *ConfigManager) {
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   true, CLIFlag: "staking", EnvVar: "FIX_STAKING",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   true, CLIFlag: "reservebalance", EnvVar: "FIX_RESERVE_BALANCE",
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "p2p-port", EnvVar: "FIX_NETWORK_PORT",
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "p2p-bind", EnvVar: "FIX_LISTEN_ADDR",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_LISTEN",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_MAX_PEERS",
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_UPNP",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_PROXY",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_EXTERNAL_IP",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_SEEDS",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_ADD_NODES",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_BAN_SCORE",
			Validation: minmax(1, 10000),
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_NETWORK_BAN_TIME",
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_RPC_ENABLED",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "bind", EnvVar: "FIX_RPC_HOST",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "rpc-port", EnvVar: "FIX_RPC_PORT",
			Validation: minmax(1024, 65535),
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "rpc-user", EnvVar: "FIX_RPC_USERNAME",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "rpc-password", EnvVar: "FIX_RPC_PASSWORD",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_RPC_MAX_CLIENTS",
			Validation: minmax(1, 10000),
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, CLIFlag: "masternode", EnvVar: "FIX_MASTERNODE_ENABLED",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_MASTERNODE_PRIVATE_KEY",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_MASTERNODE_MNCONF",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   false, EnvVar: "FIX_MASTERNODE_MNCONFLOCK",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			EnvVar: "FIX_MASTERNODE_DEBUG_MAX_MB",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			EnvVar: "FIX_MASTERNODE_DEBUG_MAX_FILES",
		},
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   true, CLIFlag: "log-level", EnvVar: "FIX_LOGGING_LEVEL",
	...
	cm.Register(&settingDef{
		SettingMeta: SettingMeta{
			...
			HotReload:   true, EnvVar: "FIX_LOGGING_FORMAT",
