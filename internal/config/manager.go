...
// It owns fixd.yml, supports CLI overrides, and notifies subscribers of changes.
...
// LoadOrCreate loads fixd.yml if it exists, or creates a default one with comments.
...
// a network API), and the values already exist in the user's fixd.yml on
