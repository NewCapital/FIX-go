...
// generateCommentedYAML creates a well-commented fixd.yml with all default values.
...
func (cm *ConfigManager) generateCommentedYAML() error {
	...
	// File header
	b.WriteString("# ==========================================\n")
	b.WriteString("# FIX Core Configuration (fixd.yml)\n")
	b.WriteString("# ==========================================\n")
	b.WriteString("#\n")
	...
	b.WriteString("# Environment variables (FIX_*) override this file but not CLI flags.\n")
	b.WriteString("#\n")
...
// GenerateDefaultConfig creates a default fixd.yml at the given path.
