...
export interface ReceiveState {
  ...
  // Per-address spendable balances (address -> balance in FIX)
...
export interface ReceiveActions {
  ...
  createPaymentRequest: (unit?: 'FIX' | 'mFIX' | 'uFIX') => Promise<PaymentRequest | null>;
...
export const createReceiveSlice: SliceCreator<ReceiveSlice> = (set, get) => ({
  ...
  createPaymentRequest: async (unit = 'FIX' as 'FIX' | 'mFIX' | 'uFIX') => {
    const state = get();
