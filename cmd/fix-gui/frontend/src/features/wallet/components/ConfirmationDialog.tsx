...
export interface ConfirmationDialogProps {
  ...
  splitCount?: number;
  splitOutputSize?: number; // Size per output in FIX
}
                    ...
                    {hasCoinControlSelection && (
                      <div className="qt-hbox" style={{ gap: '8px', alignItems: 'center' }}>
                        ...
                        <span className="qt-label" style={{ fontSize: '11px' }}>
                          ...
                          {coinControlSelectedAmount !== undefined && ` (${formatAmount(coinControlSelectedAmount)} ${t('common:units.fix')})`}
                        </span>
                      </div>
                    )}
                ...
                <div className="qt-frame-secondary" style={{
                  ...
                  <div className="qt-vbox" style={{ gap: '8px' }}>
                    ...
                    <div className="qt-hbox" style={{ gap: '8px', alignItems: 'center' }}>
                      ...
                      <span className="qt-label" style={{ fontSize: '11px' }}>
                        {splitCount} outputs @ {formatAmount(splitOutputSize || 0)} {t('common:units.fix')} each
                      </span>
                    </div>
                  </div>
                </div>
