      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        ...
        {block.is_pos && (
          <div style={{
            ...
            <InfoRow label={t('explorer.totalReward')} value={`${block.total_reward.toFixed(2)} FIX`} />
            <InfoRow label={t('explorer.stakeReward')} value={`${block.stake_reward.toFixed(2)} FIX`} />
            <InfoRow label={t('explorer.masternodeReward')} value={`${block.masternode_reward.toFixed(2)} FIX`} />
