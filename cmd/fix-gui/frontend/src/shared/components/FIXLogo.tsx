...
export const FIXLogo: React.FC<FIXLogoProps> = ({ size = 48, className = '' }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Double W effect for "fix" concept */}
      <path
        d="M 20 30 L 30 65 L 40 40 L 50 65 L 60 40 L 70 65 L 80 30"
        stroke="url(#fixGradient)"
        strokeWidth="2"
...
export const FIXLogoSimple: React.FC<FIXLogoProps> = ({ size = 48, className = '' }) => {
  return (
    <div
      className={className}
      style={{
