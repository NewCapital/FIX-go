...
import { getUnitLabel, DISPLAY_UNIT_FIX, DISPLAY_UNIT_MFIX, DISPLAY_UNIT_UFIX } from '@/shared/utils/format';
import '@/styles/qt-theme.css';

const UNIT_OPTIONS = [
  { value: DISPLAY_UNIT_FIX, label: 'FIX' },
  { value: DISPLAY_UNIT_MFIX, label: 'mFIX' },
  { value: DISPLAY_UNIT_UFIX, label: 'µFIX' },
];
