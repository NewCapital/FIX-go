// MasternodeTier represents the 4 tiers of FIX masternodes
...
export interface PaymentStatsEntry {
  ...
  totalPaid: number;      // Total paid in FIX
...
export interface PaymentStatsResponse {
  totalPaid: number;          // Total paid across all MNs in FIX
