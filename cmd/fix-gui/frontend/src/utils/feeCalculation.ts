/**
 * Fee calculation utilities for FIX wallet transactions
 * Uses satoshi-based arithmetic for precision
 */

// Network constants
export const MIN_RELAY_FEE = 0.00001; // FIX per KB - minimum network relay fee
export const HIGH_FEE_THRESHOLD = 0.01; // FIX per KB - warn if fee rate exceeds this
export const DEFAULT_FEE_RATE = 0.0005; // FIX per KB - default normal fee rate
export const SATOSHIS_PER_FIX = 100000000; // 1 FIX = 100,000,000 satoshis
...
// Minimum transaction fee in FIX (10000 satoshis = wallet default MinTxFee)
 ...
 * @param feeRate Fee rate in FIX per KB
 * @returns Fee amount in FIX
 */
 ...
 * @param feeAmount Fee amount in FIX
 * @param transactionAmount Transaction amount in FIX
 ...
 * @param rate Fee rate in FIX per KB
 ...
 * @param amount Fee amount in FIX
 * @returns Formatted string with 8 decimal places
 */
