/**
 * Address sanitization utilities for FIX wallet
 * Provides security against injection attacks and malformed input
 */

// Maximum allowed length for a FIX address
...
export function sanitizeAddress(address: string): string {
  ...
  // This keeps only valid characters for FIX addresses
...
/**
 * Checks if an address starts with a valid FIX prefix
