...
var settingsMetadataMap = map[string]SettingMetadata{
	// === Main Tab ===
	// NOTE: nDatabaseCache and nThreadsScriptVerif moved to ConfigManager (fixd.yml)
	"language": {
		Key:             "language",
		Tab:             "main",
	...
	"nStakeSplitThreshold": {
		...
		DefaultValue:    int64(200000 * 100000000), // 200000 FIX in satoshis
		MinValue:        int64(0),
	...
	"nDisplayUnit": {
		...
		Tab:             "display",
		RequiresRestart: false,
		DefaultValue:    0, // 0=FIX, 1=mFIX, 2=uFIX
		MinValue:        0,
		MaxValue:        2,
	},
	"digits": {
